  ...
  onFilterItemClick:function(menuIndex){
    ...
    if(menuIndex[0]===0){
      ...
      if(this.selectedDesignationIndex!==null){
        this.designationSubMenuList[this.selectedDesignationIndex]["submenuItemIcon"]="checkboxinactive.png";
      }
      if(this.selectedDesignationIndex===menuIndex[1]){
        this.selectedDesignationIndex=null;
      }else{
        this.selectedDesignationIndex=menuIndex[1];
      }*/
    }
    this.processFilterData();
  },
